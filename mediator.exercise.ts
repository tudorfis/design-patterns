import { SignUpDialogBox } from "./mediator-exercise/SignUpDialogBox";

const UiDialogBox = new SignUpDialogBox();
UiDialogBox.simulateUXBehaviour();

// Exercise

// We’re using a third-party GUI framework for building an application.
// We need to build a dialog box for a new user to sign up. On this dialog box
//  we need three UI elements: 
...
// coordination between these elements in a class called SignUpDialogBox.  